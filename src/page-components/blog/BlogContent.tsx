      ...
      <div className="relative w-full md:flex md:items-start">
        <div className="hidden md:flex flex-col gap-4 md:mr-6 pr-4">
          <a
            ...
            href="#"
            className="w-10 h-10 rounded-full border border-black bg-black text-white flex items-center justify-center hover:bg-white hover:text-black transition-colors"
          >
            <svg
          ...
          >
            <svg
              ...
              className="w-5 h-5"
            >
              <path d="M17.525 3H20l-6.54 7.47L21.5 21h-5.5l-4.3-5.2L6.7 21H4l7.01-8.01L3 3h5.5l3.9 4.7L17.525 3zm-1.93 16h1.53L8.49 5H6.96l8.635 14z" />
            </svg>
          </a>
        </div>
