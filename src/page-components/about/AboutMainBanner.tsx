                ...
                <div className='flex flex-col'>
                    ...
                    <div className='lg:pt-11 pt-5'>
                        <button 
                            ...
                            className='bg-[#1656A5] lg:p-[8px] p-[8px] h-[40px] w-[150px] lg:h-[56px] lg:w-[188px] text-[12px] lg:text-[14px]  text-[#F9F9F9] rounded-[8px] lg:rounded-[16px] hover:bg-[#000] hover:cursor-pointer transition'
                        >
