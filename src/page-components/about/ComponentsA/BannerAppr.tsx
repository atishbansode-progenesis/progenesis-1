...
//     const currentTab = mobileTabRefs.current[activeTab];
//     if (currentTab) {
//       // Use offsetLeft and offsetWidth for accurate positioning relative to parent container
...
//               key={s.tab}
//               ref={(el) => (mobileSlideRefs.current[index] = el)}
//               className={`relative snap-start shrink-0 rounded-2xl bg-[#000000B2] overflow-hidden bg-cover bg-center text-[#F9F9F9] shadow-lg border border-white/10`}
//               style={{ 
          ...
          {slides.map((s, index) => (
            ...
            >
              ...
              <div className="mb-[30px] relative">
                ...
                {/* Sliding underline */}
                <div className={`absolute bottom-0 left-4 right-4 pl-4 h-[1px] w-[200px] transition-colors ${activeTab === index ? 'bg-[#1656A5]' : 'bg-[#E5E5E5]'}`} />
              </div>
