...
const JoinUs: React.FC = () => {
  ...
  return (
    <div className="flex bg-[url('/images/gradient-mob-bg.png')] csLg:bg-[url('/images/gradient-banner.png')] bg-cover bg-center flex-col pt-[40px] csLg:flex-row justify-between csLg:justify-end w-full relative csLg:min-h-[500px] min-h-[515px]    ">
      ...
      {/* Content */}
      <div className="csLg:max-w-[70%] flex flex-col justify-center items-center csLg:items-start text-center csLg:text-left text-white gap-6 px-2">
        ...
        <button className="w-[120px] h-[44px] csLg:w-[150px] csLg:h-[48px] py-2.5 border border-[#1656A5] rounded-[8px] lg:rounded-[16px] bg-white text-[#1656A5] text-[14px] cursor-pointer shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:bg-[#f4f4f4] transition" onClick={()=>router.push("/careers")}>
