...
const HeroInter = () => {
    ...
    return (
        <div className='bg-gradient-to-r grid bg-[url("/images/ip-mob.png")] h-[520px] md:h-auto  csLg:bg-[url("/images/ip-desk.png")] bg-cover overflow-hidden  bg-center  '>
