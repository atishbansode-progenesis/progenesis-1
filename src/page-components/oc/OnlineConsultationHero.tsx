                ...
                <div className='flex flex-col'>
                    <div className='lg:pb-[44px] pb-[16px]'>
                        <h2 className='font-manrope text-[12px] md:text-[16px] csLg:text-[18px] font-medium leading-[26px] tracking-[-0.02em]'>
                           <button onClick={() => window.location.href = '/'} className='hover:cursor-pointer'> Home </button><span className="px-[12px]">›</span> <span className="text-[#1656A5]"> Online Consultation </span>
                        </h2>
                    </div>
