      ...
      <div className="">
        <div className="w-full flex flex-col xl:flex-row justify-between gap-[8px]">
          <div className="w-full">
            ...
            <h2 className="text-[32px] lg:text-[40px] md:text-[40px] font-light text-[#2C2C2C] leading-[40px] md:leading-[56px]">
              Common Causes of Female Infertility You Should Know
            </h2>
          </div>
          <div className="w-full">
            <p className="text-[#2C2C2C] font-light text-[20px] md:text-[24px] leading-[28px] md:leading-[36px]">
