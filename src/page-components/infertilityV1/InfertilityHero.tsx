...
const InfertilityHero = () => {
    ...
    return (
        <div className='bg-gradient-to-r grid bg-[url("/images/infertility-mob.png")] h-[520px] md:h-auto lg:h-[400px] csLg:bg-[url("/images/infertility-banner.png")] bg-cover overflow-hidden  bg-center '>
