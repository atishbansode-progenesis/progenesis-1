    ...
    <div className="bg-white min-h-screen">
      ...
      <section ref={videoSectionRef} className="bg-gradient-to-b from-gray-50 to-white p-4 lg:px-[120px] lg:pt-[80px] lg:pb-[60px]">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-[36px] lg:text-[56px] leading-[44px] lg:leading-[64px] max-w-[800px] font-normal mt-3 mx-auto">
            Inspiring Stories of Strength & Victories
          </h1>
          <p className="text-gray-600 text-[16px] lg:text-[18px] mt-4 max-w-[700px] mx-auto">
