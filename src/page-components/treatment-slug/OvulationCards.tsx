...
export const OvulationCards: React.FC<OvulationCardsProps> = ({ tag, heading, cards }) => {
  return (
    <section id="who-can-benefit" className="px-4 py-4 csLg:px-[120px] csLg:py-[80px] w-full bg-white">
      {tag && (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 w-full">
       ...
       >
          ...
          src={card.icon}
          alt={card.title}
          className="w-[19px] h-[19px] md:w-8 md:h-8 object-contain lg:mb-[14px]"
        />
