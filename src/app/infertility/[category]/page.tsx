...
export default function InfertilityCategoryPage({ params }: { params: { category: string } }) {
  const router = useRouter();
  const category = (params?.category || "").toLowerCase();

  useEffect(() => {
    // Valid categories that should scroll within the main infertility page
  ...
  // Render the same content as /infertility and let the effect scroll to the right section
