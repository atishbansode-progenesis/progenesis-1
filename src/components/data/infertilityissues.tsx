...
export const repeatedIUIFailuresData = {
  hero: {
    ...
    overlayImageSmall:"/InfertilityIssues/IFBG.png",
  ...
  statistics: {
    ...
    skyCircleData: {
      value: "5–10%",
      description: "The success rate of a single IUI cycle is only 5–10%, meaning multiple attempts are often needed."
    },
  },
  steps: {
    tag: "Fast Facts",
...
// data/pregnancyAfterMenopauseData.ts
export const pregnancyAfterMenopauseData = {
  hero: {
    breadcrumbs: [
      { label: "Home", href: "/" },
      { label: "Infertility", href: "/infertility" },
    ...
    buttonText: "Book Your Appointment",
    buttonLink: "/book-appointment",
    overlayImage: "/PregnancyMenopauseIssue/hero.png",
    overlayImageSmall:"/PregnancyMenopauseIssue/pem.png",
    breadcrumbColor: "#FFFFFF",
    breadcrumbActiveColor: "#A8D24E",
    titleColor: "#F9F9F9",
  ...
  infoGrid: {
    tag: "Know the Basics",
    heading: "Menopause: causes, signs, and treatments for parenthood.",
    items: [
      {
        id: 1,
        title: "Definition",
  ...
  carousel: {
    tag: "Key Factors",
    heading: "Key Factors Enabling Pregnancy After Menopause",
    slides: [
      {
        id: "01",
  ...
  statistics: null,
  cardStatistics: {
    tag: "Recognizing the Signs of Menopause",
    heading: "Common Symptoms Every Woman Should Know",
  ...
  steps: {
    tag: "Fast Facts",
    heading: "Recommended Next Steps After Treatment Failures",
    steps: [
      {
        id: 1,
...
// data/repeatedIVFFailuresData.ts
export const repeatedIVFFailuresData = {
  hero: {
    breadcrumbs: [
      { label: "Home", href: "/" },
      { label: "Infertility", href: "/infertility" },
    ...
    buttonText: "Book Your Appointment",
    buttonLink: "/book-appointment",
    overlayImage: "/InfertilityIssues/ivf-hero.png",
    overlayImageSmall:"/InfertilityIssues/ivf-hero-small.png",
    breadcrumbColor: "#606060",
    breadcrumbActiveColor: "#1656A5",
    titleColor: "#000000",
    buttonBgColor: "#252525",
  ...
  infoGrid: {
    tag: "Know the Basics",
    heading: "Repeated IVF failures: causes, signs, <br />and treatments for parenthood.",
    items: [
      {
        id: 1,
        title: "Definition",
...
export const lowAMHData = {
  hero: {
    ...
    buttonText: "Book Your Appointment",
    buttonLink: "/book-appointment",
    overlayImage: "/InfertilityIssues/lowamh-hero.png",
    overlayImageSmall:"/InfertilityIssues/low-AMH1.png",
    breadcrumbColor: "#606060",
    breadcrumbActiveColor: "#1656A5",
    titleColor: "#000000",
    buttonBgColor: "#252525",
  ...
  infoGrid: {
    tag: "Know the Basics",
    heading: "Low AMH: causes, signs, and treatments for parenthood.",
    items: [
      {
        id: 1,
        title: "Definition",
...
// data/polycysticOvarianSyndromeData.ts
export const polycysticOvarianSyndromeData = {
  hero: {
    breadcrumbs: [
      { label: "Home", href: "/" },
      { label: "Infertility", href: "/infertility" },
    ...
    overlayImageSmall:"/InfertilityIssues/PCOS-Mob.png",
    breadcrumbColor: "#606060",
    breadcrumbActiveColor: "#1656A5",
    titleColor: "#000000",
    buttonBgColor: "#252525",
  ...
  infoGrid: {
    tag: "Know the Basics",
    heading: "PCOS: causes, signs, and treatments for parenthood.",
    items: [
      {
        id: 1,
        title: "Definition",
  ...
  carousel: {
    tag: "Causes",
    heading: "Understanding the Key Factors That Cause PCOS",
    slides: [
      {
        id: "01",
...
// data/tubalBlockageData.ts
export const tubalBlockageData = {
  hero: {
    breadcrumbs: [
      { label: "Home", href: "/" },
      { label: "Infertility", href: "/infertility" },
  ...
  infoGrid: {
    tag: "Know the Basics",
    heading: "Understanding Tubal Blockage: causes, symptoms, and care.",
    items: [
      {
        id: 1,
        title: "Definition",
  ...
  carousel: {
    tag: "Causes",
    heading: "Understanding the Key Factors That Cause Tubal Blockage",
    slides: [
      {
        id: "01",
  ...
  cardStatistics: {
    tag: "Early Detection",
    heading: "Recognizing Early Indicators of Tubal Blockage",
    card1: {
      title: "Difficulty conceiving despite unprotected intercourse",
      icon: "/InfertilityIssues/tubal-blockage-icon1.png",
    },
    card2: {
      title: "Persistent pelvic or lower abdominal discomfort",
      icon: "/InfertilityIssues/tubal-blockage-icon2.png",
    },
    card3: {
      title: "Abnormal vaginal discharge or mild recurring fever",
      icon: "/InfertilityIssues/tubal-blockage-icon3.png",
    },
  },

  steps: {
    tag: "Treatment",
    heading: "Key Treatment Steps for Tubal Blockage",
    steps: [
      {
        id: 1,
...
// data/uterineFibroidsData.ts
export const uterineFibroidsData = {
  hero: {
    breadcrumbs: [
      { label: "Home", href: "/" },
      { label: "Infertility", href: "/infertility" },
    ...
    buttonText: "Book Your Appointment",
    buttonLink: "/book-appointment",
    overlayImage: "/InfertilityIssues/uterine-hero.png",
    overlayImageSmall:"/InfertilityIssues/UF_Mob.png",
    breadcrumbColor: "#606060",
    breadcrumbActiveColor: "#1656A5",
    titleColor: "#000000",
    buttonBgColor: "#252525",
  ...
  infoGrid: {
    tag: "Know the Basics",
    heading: "Understanding Uterine Fibroids: Causes, Symptoms, and Care.",
    items: [
      {
        id: 1,
        title: "Definition",
  ...
  cardStatistics: {
    tag: "Early Detection",
    heading: "Recognizing Indicators of Uterine Fibroids",
    card1: {
      title: "Periods may be unusually heavy or last longer than normal.",
      icon: "/InfertilityIssues/fibroids-icon1.png",
    },
    card2: {
      title: "A feeling of fullness or pressure in the lower abdomen.",
      icon: "/InfertilityIssues/fibroids-icon2.png",
    },
    card3: {
      title: "Pressure on the bladder may cause an increased need to urinate.",
      icon: "/InfertilityIssues/fibroids-icon3.png",
    },
  },
...
// data/azoospermiaData.ts
export const azoospermiaData = {
  hero: {
    breadcrumbs: [
      { label: "Home", href: "/" },
      { label: "Infertility", href: "/infertility" },
  ...
  carousel: {
    tag: "Causes",
    heading: "Understanding the Key Factors That Cause Azoospermia",
    slides: [
      {
        id: "01",
  ...
  cardStatistics: {
    tag: "Early Detection",
    heading: "Recognizing Indicators of Azoospermia",
    card1: {
      title: "Low sex drive",
      icon: "/InfertilityIssues/azoospermia-icon1.png",
    },
    card2: {
      title: "Decreased hair on face and body",
      icon: "/InfertilityIssues/azoospermia-icon2.png",
    },
    card3: {
      title: "Lump/swelling around testicles",
      icon: "/InfertilityIssues/azoospermia-icon3.png",
    },
  },
...
// data/lowSpermCountData.ts
export const lowSpermCountData = {
  hero: {
    breadcrumbs: [
      { label: "Home", href: "/" },
      { label: "Infertility", href: "/infertility" },
    ...
    buttonText: "Book Your Appointment",
    buttonLink: "/book-appointment",
    overlayImage: "/InfertilityIssues/LSC-Mob.png",
    overlayImageSmall:"",
    breadcrumbColor: "#FFFFFF",
    breadcrumbActiveColor: "#1656A5",
    titleColor: "#F9F9F9",
  ...
  carousel: {
    tag: "Causes",
    heading: "Understanding the Key Factors That Cause Low Sperm Count",
    slides: [
      {
        id: "01",
  ...
  cardStatistics: {
    ...
    card2: {
      ...
      icon: "/InfertilityIssues/low-sperm-icon2.png",
    },
    card3: {
      title: "Lump/ swelling around the testicles",
      icon: "/InfertilityIssues/low-sperm-icon3.png",
    },
  },
...
// data/erectileDysfunctionData.ts
export const erectileDysfunctionData = {
  ...
  carousel: {
    tag: "Causes",
    heading: "Understanding the Key Factors That Cause Erectile Dysfunction (ED)",
    slides: [
      {
        id: "01",
  ...
  cardStatistics: {
    tag: "Early Detection",
    heading: "Recognizing Indicators of Erectile Dysfunction (ED)",
    card1: {
      title: "Trouble Getting an Erection",
      icon: "/InfertilityIssues/ed-icon1.png",
    },
    card2: {
      title: "Difficulty Maintaining Erection",
      icon: "/InfertilityIssues/ed-icon2.png",
    },
    card3: {
      title: "Reduced Sexual Desire",
      icon: "/InfertilityIssues/ed-icon3.png",
    },
  },
  ...
  stories: {
    tag: "Inspiration",
    heading: "Inspiring stories of strength & victories",
    items: [
      {
        id: 1,
        title: "Triumph over ED through psychological therapy",
        image: "/InfertilityIssues/ed-story1.png",
      },
      {
        id: 2,
        title: "Lifestyle change that improved relationship intimacy",
        image: "/InfertilityIssues/ed-story2.png",
      },
      {
        id: 3,
        title: "Overcoming ED with medical and emotional support",
        image: "/InfertilityIssues/ed-story3.png",
      },
    ],
  },

  appointmentCTA: {
    heading: "Just a few steps toward your better tomorrow.",
    subheading: "Book your consultation today and rediscover confidence.",
    buttonText: "Book Appointment",
    buttonLink: "/book-appointment",
    image: "/InfertilityIssues/ed-cta.png",
  },
...
// data/endometriosisData.ts
export const endometriosisData = {
  hero: {
    breadcrumbs: [
      { label: "Home", href: "/" },
      { label: "Infertility", href: "/infertility" },
    ...
    overlayImageSmall:"/InfertilityIssues/endometriosis-mob.png",
    breadcrumbColor: "#FFFFFF",
    breadcrumbActiveColor: "#1656A5",
    titleColor: "#F9F9F9",
    buttonBgColor: "#FFFFFF",
  ...
  steps: {
    tag: "Next Steps",
    heading: "Recommended Steps to Cure Endometriosis",
    steps: [
      {
        id: 1,
