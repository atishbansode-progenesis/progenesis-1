...
export default function Navbar({ doctors, centersData }: { doctors: Doctor[]; centersData: Center[] }) {
  ...
  return (
    <>
      <header
        className={`${isSticky ? "sticky" : "relative"} top-0 left-0 right-0 z-50 w-full bg-white font-sans shadow-sm`}
      >
        {/* NAVBAR */}
        {!isSearchOpen && (
          <div className=" mx-auto flex items-center justify-between h-20 px-6   csLg:px-[120px]">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="cursor-pointer hidden md:flex items-center justify-center h-10 w-10 rounded-lg bg-gray-100 hover:bg-gray-200 transition"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
