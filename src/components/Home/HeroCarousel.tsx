...
const HeroCarousel = () => {
  ...
  return (
    <div className="relative w-full h-[100vh] overflow-hidden bg-black">
      ...
      {/* Overlay Content */}
      <div className="absolute bottom-0 left-0 pb-[20%] md:pb-[10%] px-6 lg:px-[50px] xl:px-[80px] 2xl:px-[120px] text-white max-w-[900px] z-30 transition-all duration-700 ease-in-out">
        <p
          className="
            font-[Manrope] font-semibold text-[var(--BG_White,#FFF)]
            text-[32px] leading-[40px] tracking-[-0.64px] 
            md:text-[56px] md:leading-[64px] md:tracking-[-1px]
            xl:text-[80px] xl:leading-[88px] xl:tracking-[-1.6px]
            max-w-full md:w-[753px] font-normal not-italic
            transition-all duration-700 ease-in-out
          "
        >
          {slides[currentSlide].title}
        ...
        <div className="hidden md:flex flex-row gap-3 mt-6 md:mt-12">
          {slides[currentSlide].buttons.map((btn, i) => (
            <Link key={i} href={btn.href}>
              <button
                className={`cursor-pointer px-[12px] md:px-12 py-[12px] md:py-3 md:rounded-[16px] rounded-[8px] font-[Manrope] text-[12px] md:text-sm font-medium leading-[20px] sm:leading-6 tracking-[-0.24px] sm:tracking-[-0.28px] transition-all duration-300 ease-in-out ${
        ...
        {/* Mobile Only Buttons - Home, Centers, Contact */}
        <div className="flex md:hidden flex-row gap-3 mt-6">
          <Link href="/">
            <button className="cursor-pointer px-[16px] py-[10px] rounded-[8px] font-[Manrope] text-[14px] font-medium leading-[20px] tracking-[-0.24px] bg-white text-[#2C2C2C] backdrop-blur-[7.5px] transition-all duration-300 ease-in-out">
              Home
            </button>
          </Link>
          <Link href="/centers">
            <button className="cursor-pointer px-[16px] py-[10px] rounded-[8px] font-[Manrope] text-[14px] font-medium leading-[20px] tracking-[-0.24px] border border-white text-white backdrop-blur-[7.5px] transition-all duration-300 ease-in-out">
              Centers
            </button>
          </Link>
          <Link href="/contact">
