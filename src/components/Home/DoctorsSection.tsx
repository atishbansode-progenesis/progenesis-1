  ...
  return (
    <section className="py-20 bg-[#F9FAFB] px-4 md:px-[80px] lg:px-[120px] ">
      <div>
        {/* Heading */}
        <div
          className="flex flex-col md:flex-row items-start justify-between gap-[12px] mb:gap-[144px] mb-[144px] md:mb-[144px]"
          ref={ref}
        >
          {/* Left */}
          <div className="max-w-[560px]">
          ...
          {/* Right - Static paragraph (no animation now) */}
          <div className="max-w-3xl text-[#2C2C2C] text-sm md:text-[32px] md:leading-[40px] leading-8 tracking-[-0.32px] md:tracking-[-0.64px] font-[Manrope] font-normal">
            {text}
          </div>
        </div>
