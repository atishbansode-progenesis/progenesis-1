...
// // ❌ Commented out the animated Letter component
// /*
...
//       {/* Heading */}
//       <div
//         className="flex flex-col md:flex-row items-start justify-between gap-8  mb-[144px] md:mb-[144px]"
//         ref={ref}
//       >
//         {/* Left */}
...
//         {/* ✅ Replaced animated text with static styled paragraph */}
//         <div
//           className="flex-1"
//           style={{
//             width: "691px",
    ...
    <section className="py-20 bg-[#F9FAFB] px-6 lg:px-[50px] xl:px-[80px] 2xl:px-[120px]">
      ...
      >
        ...
        <div className="flex-1">
          <p
            className="
              text-[#2C2C2C] font-[Manrope] 
              text-base sm:text-lg md:text-[32px] leading-7 md:leading-[40px] 
              tracking-[-0.64px] font-normal max-w-[691px]
            "
          >
            {text}
          </p>
      ...
      <div className="relative flex items-center">
        ...
        >
          ...
          <div className="flex justify-center items-center flex-shrink-0 rounded-xl overflow-hidden bg-[#27C3EB]">
            <img
              src={doctor.image}
              alt={doctor.name}
              className="h-full w-full object-cover rounded-xl"
          ...
          <div className="flex flex-col justify-between flex-1 px-3 sm:px-6 md:px-10 mt-4 md:mt-0">
            <h3 className="text-[#1656A5] font-[Manrope] text-2xl sm:text-3xl md:text-4xl 2xl:text-5xl leading-tight tracking-tight">
              {doctor.name}
            </h3>

            <p className="mt-4 text-[#606060] font-[Manrope] text-sm sm:text-base leading-relaxed tracking-tight">
              {doctor.description}
            </p>
            ...
            <div className="mt-6 md:mt-10 flex flex-wrap gap-3">
              {doctor.experience.map((exp, idx) => (
                <div
                  key={idx}
                  className="px-4 py-2 rounded-xl bg-[rgba(22,86,165,0.05)] text-[#1656A5] font-[Manrope] text-sm backdrop-blur-[25px]"
                >
                  {exp}
                </div>
              ))}
          ...
          <div className="hidden md:block w-[1px] h-auto my-4 md:my-0 mx-6 bg-black/25 self-stretch"></div>

          <div className="flex flex-col justify-end px-3 sm:px-6 md:px-10 mt-6 md:mt-0">
            <h4 className="text-[#2C2C2C] font-[Manrope] text-3xl sm:text-4xl md:text-5xl font-normal leading-tight">
              {doctor.location}
            </h4>
            <p className="text-[#2C2C2C] font-[Manrope] text-sm sm:text-base md:text-lg">
              {doctor.role}
            </p>
          </div>
        </div>
