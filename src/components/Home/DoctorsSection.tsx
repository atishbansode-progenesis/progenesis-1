...
const DoctorsSection = () => {
  ...
  return (
    <section className="py-20 bg-[#F9FAFB] px-6 lg:px-[50px] xl:px-[80px] 2xl:px-[120px]">
      ...
      {/* Heading */}
      <div className="flex flex-col md:flex-row items-start justify-between gap-8 mb-20 md:mb-36" ref={ref}>
        {/* Left */}
        <div className="w-full max-w-full sm:max-w-xl md:max-w-xl lg:max-w-lg xl:max-w-3xl">
          <span className="inline-block text-sm font-medium text-blue-700 bg-blue-100 px-3 py-1 rounded-full mb-6">
            The Experts
      ...
      <div className="relative flex items-center pb-8">
        {/* Counter */}
        <div className="absolute -top-16 right-0 text-[#606060] font-[Manrope] text-sm font-semibold tracking-tight">
          {String(currentIndex + 1).padStart(2, "0")} of{" "}
          {String(doctors.length).padStart(2, "0")}
        </div>
        ...
        {/* Content Container */}
        <div className="w-full flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-10 items-stretch">
          
          {/* Image Section */}
          <div className="w-full md:w-1/3 lg:w-2/5 flex-shrink-0">
            <div className="w-full aspect-square md:aspect-auto md:h-80 lg:h-96 rounded-2xl overflow-hidden bg-[#27C3EB]">
              <img
                src={doctor.image}
                alt={doctor.name}
          ...
          <div className="flex-1 flex flex-col justify-between min-w-0">
            <div>
              <h3 className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-semibold text-[#1656A5] leading-tight mb-4">
                {doctor.name}
              </h3>
              <p className="text-sm sm:text-base text-[#606060] leading-relaxed mb-6">
                {doctor.description}
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              {doctor.experience.map((exp, idx) => (
                <div
                  key={idx}
                  className="px-3 py-2 rounded-lg bg-[rgba(22,86,165,0.08)] text-[#1656A5] font-[Manrope] text-xs sm:text-sm whitespace-nowrap"
                >
                  {exp}
                </div>
              ))}
          ...
          {/* Right Section */}
          <div className="w-full md:w-auto md:flex-shrink-0 flex flex-col justify-end border-t md:border-t-0 md:border-l border-gray-200 pt-6 md:pt-0 md:pl-8 lg:pl-10">
            <h4 className="text-3xl sm:text-4xl md:text-3xl lg:text-4xl font-semibold text-[#2C2C2C] leading-tight">
              {doctor.location}
            </h4>
            <p className="text-sm sm:text-base text-[#2C2C2C] mt-2">
              {doctor.role}
            </p>
          </div>
        </div>
        ...
        <button
          onClick={nextDoctor}
          className="absolute -right-16 w-[40px] h-[40px] hidden md:flex items-center justify-center rounded-lg border border-blue-600 text-blue-600 hover:bg-blue-50 flex-shrink-0 cursor-pointer"
        >
